...
func (bs *VSYSBlockScanner) SaveLocalBlockHead(blockHeight uint32, blockHash string) error {
...
func (bs *VSYSBlockScanner) GetLocalBlockHead() (uint32, string, error) {
...
func (bs *VSYSBlockScanner) SaveLocalBlock(blockHeader *Block) error {
...
func (bs *VSYSBlockScanner) GetLocalBlock(height uint32) (*Block, error) {
...
func (bs *VSYSBlockScanner) SaveUnscanRecord(record *openwallet.UnscanRecord) error {
...
func (bs *VSYSBlockScanner) DeleteUnscanRecord(height uint32) error {
...
func (bs *VSYSBlockScanner) GetUnscanRecords() ([]*openwallet.UnscanRecord, error) {
